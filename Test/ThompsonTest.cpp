...
public:
	...
	void ThompsonTest1()
	{
		...
		**/
		...
		cout << "fa6:" << fa6 << endl;
		DFA DFA1 = fa6.determinism();
		cout << "————————DFA1:" << DFA1 << endl;//——————————————————————成功转换成DFA
		minTest(DFA1);
		/**文档p22
		Q = [0,10), S ={0}, F = {1}
		...
		**/
		...
		cout << "fa7:" << fa7 << endl;
		cout << "\nThompson1\n" <<endl;
		DFA DFA2 = fa7.determinism();
        cout << "————————DFA2:" << DFA2 << endl;//——————————————————————成功转换成DFA
		minTest(DFA2);
		/**
		Q = [0,10), S = {0}, F = {1}
		...
		**/
		...
		cout << "fa8:" << fa8 << endl;
		DFA DFA3 = fa8.determinism();
		cout << "————————DFA3:" << DFA3 << endl;//——————————————————————成功转换成DFA
		minTest(DFA3);
		/**
		Q = [0,12), S = {0}, F = {1}
		...
		**/
		...
		DFA DFA4 = fa9.determinism();
		cout << "————————DFA4:" << DFA4 << endl;//——————————————————————成功转换成DFA
		minTest(DFA4);
		...
		**/
		...
		DFA DFA5 = fa10.determinism();
		cout << "————————DFA5:" << DFA5 << endl;//——————————————————————成功转换成DFA
		minTest(DFA5);
	...
	void ThompsonTest11()
	{
		...
		FA fa1(re1);
		FA fb1 = FA(re1);   // 等效
		FA fc1 = Thompson(re1);  // 等效
		cout << "________________测试" << endl;
		cout << "\nfa1:" << fa1 << "\nfb1:" << fb1<<"\nfc1:" << fc1<< endl;
	...
	****************************************************************/
	void Thompson_sigmaTest1()
	{
		...
		**/
		...
		cout << "fa6:" << fa6 << endl;
		DFA DFA1S = fa6.determinism();
		cout << "————————DFA1S:" << DFA1S << endl;//——————————————————————成功转换成DFA
		minTest(DFA1S);
		/**
		Q = [0,10), S = {4}, F = {9}
		...
		**/
		...
		cout << "fa7:" << fa7 << endl;
		DFA DFA2S = fa7.determinism();
		cout << "————————DFA2S:" << DFA2S << endl;//——————————————————————成功转换成DFA
		minTest(DFA2S);
		/**
		Q = [0,10), S = {4}, F = {9}
		...
		**/
		...
		cout << "fa8:" << fa8 << endl;
		DFA DFA3S = fa8.determinism();
		cout << "————————DFA3S:" << DFA3S << endl;//——————————————————————成功转换成DFA
		minTest(DFA3S);
		/**
		Q = [0,12), S = {6}, F = {11}
		...
		**/  
		...
		DFA DFA4S = fa9.determinism();
		cout << "————————DFA4S:" << DFA4S << endl;//——————————————————————成功转换成DFA
		minTest(DFA4S);
		/**画出状态转移图可得对应的RE=(a+b)*a+(aa)*
		Q = [0,18), S = {16}, F = {17}
		...
		**/
		...
		DFA DFA5S = fa10.determinism();
		cout << "-----------------DFA5S:" << DFA5S << endl;//——————————————————————成功转换成DFA
		minTest(DFA5S);
		/**画出状态转移图可得对应的RE=((a | epsilon)+)b?cd*|(empty())
		Q = [0,22), S = {20}, F = {21}
