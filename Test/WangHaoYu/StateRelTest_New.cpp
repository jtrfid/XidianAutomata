...
public:
	...
	*****************************************************************************/
	...
	/*********************************************************************
								ImageTest
	测试函数：
	1.StateSet image(const State& r) const        返回状态0映射的StateSet
	2.StateSet image(const StateSet& r) const	  返回StateSet r中所含状态映射的StateSet
	*********************************************************************/
	void ImageTest()
	{
		cout << "ImageTest:" << endl;
	...
	/*
	closure(const StateSet& r) const 闭包:返回r以及其在*this中映射的目标StateSet
	*/
	void ClosureTest()
	{
	...
	/****************************************************************************
									移除映射测试
	测试函数：
	1.StateRel& remove_pair(const State p, const State q)			移除映射(State):p->q
	2.StateRel& remove_pairs(const StateSet& P, const StateSet& Q)	移除映射(StateSet):p->q
	****************************************************************************/
	void RemovePairTest()
	{
