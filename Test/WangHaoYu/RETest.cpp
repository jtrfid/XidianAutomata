...
public:
	...
	void SingleCharacterTest()
	{
		...
		RE re;
		ifstream infile("WangHaoYu/re1.txt");
		infile >> re;
	...
	void StringTest()
	{
		...
		RE re;
		ifstream infile("WangHaoYu/re2.txt");
		infile >> re;
	...
	*/
	void ComplexTest()
	{
		...
		RE re;
		ifstream infile("WangHaoYu/re3.txt");
		infile >> re;
		//cin >> re;//>>.*'a'*'b'
	...
	void CompareFunctionTest()
	{
		...
		ifstream infile1("WangHaoYu/re4.txt");
		infile1 >> re1;
		//cin >> re1;
		cout << "input second regular expression re2:" << endl;
		ifstream infile2("WangHaoYu/re5.txt");
		infile2 >> re2;
		//cin >> re2;
