...
The cardinality of $A/\rho$ is called the index of $\rho$; especially, if $A/\rho$ is finite, then 
is said to have a  fnite index. For any subset $H$ of $A$, $H/\rho$ denotes $\{a\rho|a\in H \}$. The
equivalence $\rho$ saturates the subset $H$, if $H$ is the union of some $\rho$-classes. Hence, $\rho$ saturates $H$ iff $a\rho\in H/\rho$ implies $a\rho\subseteq H$.
